<template>
    <div id="Content">
            ...
            <el-steps :active="5" finish-status="process ">
                <el-step title="步骤1" style="width:280px;padding-left: 50px">
                    <template slot="description">
                        <p style="font-size: 16px">下载测试超声心动图文件文件</p>
                        <br>
                        <br>
                    </template>
                </el-step>
        ...
        <el-button type="primary" @click="welcome">下载测试超声心动图图像</el-button>
      </span>
        </el-dialog>
        <el-dialog
            title="AI预测中"
                ...
                <div style="height: 600px;" class="step_1">
                    <el-steps direction="vertical" :active="active" finish-status="success">
                        ...
                        <el-step style="height: 150px;" title="步骤 2">
                            <template slot="description">
                                <!-- 上传文件 -->
                                上传超声心动图图像至服务器，使用算法预测钙化区域并返回钙化区域特征
        ...
        <!-- 上传返回信息部分：原超声心动图图部分  标出钙化的超声心动图图像 图像特征-->
        <div id="CT">
            <!-- 超声心动图图像 -->
            <div id="CT_image">
                <!-- 原超声心动图图 -->
                ...
                >
                    <div class="demo-image__preview1">
                        ...
                        <div class="img_info_1" style="border-radius:0 0 5px 5px;">
                            <span style="color:white;letter-spacing:6px;">原超声心动图图像</span>
                        </div>
                    </div>
                    <!-- 标出钙化的超声心动图图像 -->
            ...
            <div id="info_patient">
                ...
                <el-card style="border-radius: 8px;">
                    ...
                    <el-tabs v-model="activeName" @tab-click="handleClick">
                        <el-tab-pane label="钙化区域特征值" name="first">
                            <!-- 表格存放特征值 -->
                            <el-table
                                :data="feature_list"
                                height="390"
